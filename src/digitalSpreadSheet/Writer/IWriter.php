...
interface IWriter
{
     ...
     *        If this is true, then the Writer will write definitions for any charts that exist in the PhenyxXls object.
     *        If false (the default) it will ignore any charts defined in the PhenyxXls object.
     *
     * @return bool
     */
     ...
     *        Set to true, to advise the Writer to include any charts that exist in the PhenyxXls object.
     ...
     *     If false, then formulae are not calculated on save. This is faster for saving in PhenyxXls, but slower
