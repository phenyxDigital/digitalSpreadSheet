...
use phenyxDigitale\digitalSpreadSheet\Reader\DefaultReadFilter;
use phenyxDigitale\digitalSpreadSheet\Reader\IReadFilter;
...
class ColumnAndRowAttributes extends BaseParserClass {
    ...
    public function load( ? IReadFilter $readFilter = null, bool $readDataOnly = false) : void {
        ...
        if ($readFilter !== null && get_class($readFilter) === DefaultReadFilter::) {
            $readFilter = null;
        }
