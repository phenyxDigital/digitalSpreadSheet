...
use phenyxDigitale\digitalSpreadSheet\Chart\Renderer\IRenderer;
use phenyxDigitale\digitalSpreadSheet\Collection\Memory;
...
class Settings {
    ...
    /**
     * Identify to PhenyxXls the external library to use for rendering charts.
     *
    ...
    /**
     * Return the Chart Rendering Library that PhenyxXls is currently configured to use.
     *
