...
namespace phenyxDigitale\digitalSpreadSheet\Calculation\TextData;
...
use phenyxDigitale\digitalSpreadSheet\Calculation\DateTimeExcel;
use phenyxDigitale\digitalSpreadSheet\Calculation\Exception as CalcExp;
