...
use phenyxDigitale\digitalSpreadSheet\Worksheet\AutoFilter\Column\Rule;
use phenyxDigitale\digitalSpreadSheet\Worksheet\Worksheet as ActualWorksheet;
...
class AutoFilter extends WriterPart {
    ...
    private static function writeAutoFilterColumnRule(Column $column, Rule $rule, XMLWriter $objWriter): void {
        ...
        } else if ($rule->getRuleType() === Rule::AUTOFILTER_RULETYPE_DYNAMICFILTER) {
            //    Dynamic Filter Rule
        ...
        } else if ($rule->getRuleType() === Rule::AUTOFILTER_RULETYPE_TOPTENFILTER) {
            //    Top 10 Filter Rule
