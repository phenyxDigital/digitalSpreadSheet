...
use phenyxDigitale\digitalSpreadSheet\Cell\IValueBinder;
use phenyxDigitale\digitalSpreadSheet\Chart\Chart;
use phenyxDigitale\digitalSpreadSheet\Collection\Cells;
use phenyxDigitale\digitalSpreadSheet\Collection\CellsFactory;
use phenyxDigitale\digitalSpreadSheet\Comment;
...
class Worksheet implements IComparable {
    ...
    private function getWorksheetAndCoordinate(string $coordinate) : array
    {
        ...
        } else if (strpos($finalCoordinate, '$') !== false) {
    ...
    public function removeComment($cellCoordinate): self{
        ...
        if (Coordinate::coordinateIsRange($cellAddress)) {
            throw new Exception('Cell coordinate string can not be a range of cells.');
        } else if (strpos($cellAddress, '$') !== false) {
    ...
    /**
     * Run PhenyxXls garbage collector.
     *
     * @return $this
     */
    ...
    public function __clone() {
        ...
        foreach ($this as $key => $val) {
            ...
            if (is_object($val) || (is_array($val))) {
                ...
                } else if (($key == 'autoFilter') && ($this->autoFilter instanceof AutoFilter)) {
