...
class Style extends WriterPart {
    ...
    private function writeFont(XMLWriter $objWriter, Font $font): void{
        ...
        if ($font->getSuperscript() === true || $font->getSubscript() === true) {
            ...
            } else if ($font->getSubscript() === true) {
     ...
     * Write Cell Style Xf.
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \phenyxDigitale\digitalSpreadSheet\Style\Style $style, Spreadsheet $spreadsheet): void{
     ...
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \phenyxDigitale\digitalSpreadSheet\Style\Style $style) : void{
     ...
     *
     * @return \phenyxDigitale\digitalSpreadSheet\Style\Style[] All styles in PhenyxXls
     */
     ...
     *
     * @return Conditional[] All conditional styles in PhenyxXls
     */
     ...
     *
     * @return Fill[] All fills in PhenyxXls
     */
    public function allFills(Spreadsheet $spreadsheet) {
        ...
        /** @var \phenyxDigitale\digitalSpreadSheet\Style\Style $style */
     ...
     *
     * @return Font[] All fonts in PhenyxXls
     */
     ...
     *
     * @return Borders[] All borders in PhenyxXls
     */
     ...
     *
     * @return NumberFormat[] All number formats in PhenyxXls
     */
