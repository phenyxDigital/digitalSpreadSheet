...
use phenyxDigitale\digitalSpreadSheet\Cell\Hyperlink;
use phenyxDigitale\digitalSpreadSheet\DefinedName;
use phenyxDigitale\digitalSpreadSheet\Reader\Security\XmlScanner;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\AutoFilter;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\Chart;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\ColumnAndRowAttributes;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\ConditionalStyles;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\DataValidations;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\Hyperlinks;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\Namespaces;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\PageSetup;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\Properties as PropertyReader;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\SheetViewOptions;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\SheetViews;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\Styles;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\TableReader;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\Theme;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\WorkbookView;
...
use phenyxDigitale\digitalSpreadSheet\Style\Font as StyleFont;
...
class Xlsx extends BaseReader {
                    ...
                    foreach ($xmlWorkbook->sheets->sheet as $eleSheet) {
                        ...
                        while ($xml->read()) {
                            ...
                            if ($xml->localName == 'row' && $xml->nodeType == XMLReader::ELEMENT && $xml->namespaceURI === $mainNS) {
                                ...
                                $currCells = 0;
                            } else if ($xml->localName == 'c' && $xml->nodeType == XMLReader::ELEMENT && $xml->namespaceURI === $mainNS) {
                                    ...
                                    if (isset($shape['style'])) {
                                        ...
                                        if (($column !== null) && ($row !== null)) {
                                            ...
                                            if (isset($drowingImages[$fillImageRelId])) {
                                                $objDrawing = new \phenyxDigitale\digitalSpreadSheet\Worksheet\Drawing();
                                ...
                                foreach ($xmlSheetNS->drawing as $drawing) {
                                    ...
                                    if ($relsDrawing && $relsDrawing->Relationship) {
                                        ...
                                        foreach ($relsDrawing->Relationship as $ele) {
                                            ...
                                            } else if ($eleType === "$xmlNamespaceBase/chart") {
                                    ...
                                    if ($xmlDrawingChildren->oneCellAnchor) {
                                        ...
                                        foreach ($xmlDrawingChildren->oneCellAnchor as $oneCellAnchor) {
                                            ...
                                            } else if ($this->includeCharts && $oneCellAnchor->graphicFrame) {
                                    ...
                                    if ($xmlDrawingChildren->twoCellAnchor) {
                                        ...
                                        foreach ($xmlDrawingChildren->twoCellAnchor as $twoCellAnchor) {
                                            ...
                                            if ($twoCellAnchor->pic->blipFill) {
                                                ...
                                                $objDrawing->setWorksheet($docSheet);
                                            } else if (($this->includeCharts) && ($twoCellAnchor->graphicFrame)) {
                ...
                foreach ($is->r as $run) {
                    ...
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u)) {
                            ...
                            if (!isset($attr['val'])) {
                                $objFont->setUnderline(\phenyxDigitale\digitalSpreadSheet\Style\Font::UNDERLINE_SINGLE);
                            } else {
     ...
     */
    private function readHyperLinkDrawing(\phenyxDigitale\digitalSpreadSheet\Worksheet\Drawing $objDrawing, SimpleXMLElement $cellAnchor, $hyperlinks): void{
