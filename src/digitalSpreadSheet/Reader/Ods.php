...
use phenyxDigitale\digitalSpreadSheet\Reader\Ods\AutoFilter;
use phenyxDigitale\digitalSpreadSheet\Reader\Ods\DefinedNames;
use phenyxDigitale\digitalSpreadSheet\Reader\Ods\FormulaTranslator;
use phenyxDigitale\digitalSpreadSheet\Reader\Ods\PageSettings;
use phenyxDigitale\digitalSpreadSheet\Reader\Ods\Properties as DocumentProperties;
...
class Ods extends BaseReader {
    ...
    /**
     * Loads PhenyxXls from file into PhenyxXls instance.
     *
     * @param string $filename
     *
     * @return Spreadsheet
