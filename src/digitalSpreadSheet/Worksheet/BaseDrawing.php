...
class BaseDrawing implements IComparable {
    ...
    public function setWorksheet( ? Worksheet $worksheet = null, bool $overrideOld = false) : self {
        ...
        if ($this->worksheet === null) {
            // Add drawing to \phenyxDigitale\digitalSpreadSheet\Worksheet\Worksheet
            ...
            if ($overrideOld) {
                // Remove drawing from old \phenyxDigitale\digitalSpreadSheet\Worksheet\Worksheet
                ...
                // Set new \phenyxDigitale\digitalSpreadSheet\Worksheet\Worksheet
                $this->setWorksheet($worksheet);
            } else {
                throw new PhenyxXlsException('A Worksheet has already been assigned. Drawings can only exist on one \\EphenyxShop\\PhenyxXls\\Worksheet.');
            }
