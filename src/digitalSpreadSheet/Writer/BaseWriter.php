...
abstract class BaseWriter implements IWriter {
     ...
     * Identifies whether the Writer should write definitions for any charts that exist in the PhenyxXls object.
     *
     * @var bool
     */
     ...
     * Forces PhenyxXls to recalculate all formulae in a workbook when saving, so that the pre-calculated values are
