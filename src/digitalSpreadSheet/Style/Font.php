...
class Font extends Supervisor {
     ...
     *         'bold' => TRUE,
     *         'italic' => FALSE,
     *         'underline' => \phenyxDigitale\digitalSpreadSheet\Style\Font::UNDERLINE_DOUBLE,
     *         'strikethrough' => FALSE,
     *         'color' => [
     *             'rgb' => '808080'
     *         ]
     ...
     * Set Underline.
     *
     * @param bool|string $underlineStyle \phenyxDigitale\digitalSpreadSheet\Style\Font underline type
