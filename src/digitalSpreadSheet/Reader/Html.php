...
class Html extends BaseReader {
    ...
    private function processDomElementThTd(Worksheet $sheet, int &$row, string &$column, string &$cellContent, DOMElement $child, array &$attributeArray): void {
        ...
        if (isset($attributeArray['rowspan'], $attributeArray['colspan'])) {
            ...
            $column = $columnTo;
        } else if (isset($attributeArray['rowspan'])) {
            ...
            $sheet->mergeCells($range);
        } else if (isset($attributeArray['colspan'])) {
    ...
    /**
     * Loads PhenyxXls from DOMDocument into PhenyxXls instance.
     */
    ...
    public function getStyleColor($value) {
        ...
        return \phenyxDigitale\digitalSpreadSheet\Helper\Html::colourNameLookup($value);
    }
    ...
    /**
     * Map html border style to PhenyxXls border style.
     *
     * @param  string $style
     *
     * @return null|string
