...
use phenyxDigitale\digitalSpreadSheet\Chart\Axis;
use phenyxDigitale\digitalSpreadSheet\Chart\ChartColor;
use phenyxDigitale\digitalSpreadSheet\Chart\DataSeries;
use phenyxDigitale\digitalSpreadSheet\Chart\DataSeriesValues;
use phenyxDigitale\digitalSpreadSheet\Chart\GridLines;
use phenyxDigitale\digitalSpreadSheet\Chart\Layout;
use phenyxDigitale\digitalSpreadSheet\Chart\Legend;
use phenyxDigitale\digitalSpreadSheet\Chart\PlotArea;
use phenyxDigitale\digitalSpreadSheet\Chart\Properties as ChartProperties;
use phenyxDigitale\digitalSpreadSheet\Chart\Title;
use phenyxDigitale\digitalSpreadSheet\Chart\TrendLine;
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx;
...
class Chart {
     ...
     *
     * @return \phenyxDigitale\digitalSpreadSheet\Chart\Chart
     */
    public function readChart(SimpleXMLElement $chartElements, $chartName) {
        ...
        $chart = new \phenyxDigitale\digitalSpreadSheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
    ...
    private function chartTitle(SimpleXMLElement $titleDetails): Title{
        ...
        foreach ($titleDetails as $titleDetailKey => $chartDetail) {
            ...
            case 'tx':
                ...
                } else if (isset($chartDetail->strRef->strCache)) {
    ...
    private function chartDataSeriesValueSet(SimpleXMLElement $seriesDetail,  ? string $marker = null,  ? ChartColor $fillColor = null,  ? string $pointSize = null) {
        ...
        if (isset($seriesDetail->strRef)) {
            ...
            return $seriesValues;
        } else if (isset($seriesDetail->numRef)) {
            ...
            return $seriesValues;
        } else if (isset($seriesDetail->multiLvlStrRef)) {
            ...
            return $seriesValues;
        } else if (isset($seriesDetail->multiLvlNumRef)) {
    ...
    private function chartDataSeriesValues(SimpleXMLElement $seriesValueSet, string $dataType = 'n') : array
    {
        ...
        foreach ($seriesValueSet as $seriesValueIdx => $seriesValue) {
            ...
            case 'pt':
                ...
                } else if ((string) $seriesValue->v === ExcelError::NA()) {
