...
class ConvertOctal extends ConvertBase {
    ...
    public static function toBinary($value, $places = null) {
        ...
        try {
            ...
            $value = validateOctal($value);
            $places = validatePlaces($places);
        } catch (Exception $e) {
            return $e->getMessage();
        }

        return ConvertDecimal::toBinary(toDecimal($value), $places);
    }
    ...
    public static function toHex($value, $places = null) {
        ...
        $hexVal = strtoupper(dechex((int) toDecimal($value)));
