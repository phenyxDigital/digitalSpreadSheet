...
use phenyxDigitale\digitalSpreadSheet\Worksheet\BaseDrawing;
use phenyxDigitale\digitalSpreadSheet\Worksheet\Drawing as WorksheetDrawing;
...
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\Chart;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\Comments;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\ContentTypes;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\DocProps;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\Drawing;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\Rels;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\RelsRibbon;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\RelsVBA;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\StringTable;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\Style;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\Table;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\Theme;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\Workbook;
use phenyxDigitale\digitalSpreadSheet\Writer\Xlsx\Worksheet;
use ZipArchive;
...
class Xlsx extends BaseWriter {
     ...
     *
     * @var HashTable<\phenyxDigitale\digitalSpreadSheet\Style\Style>
     */
    ...
    /**
     * Private unique \phenyxDigitale\digitalSpreadSheet\Style\Font HashTable.
     *
     * @var HashTable<Font>
     */
    ...
    /**
     * Private unique \phenyxDigitale\digitalSpreadSheet\Worksheet\Worksheet\BaseDrawing HashTable.
     *
    ...
    public function save($filename, int $flags = 0): void{
        ...
        for ($i = 0; $i < $this->spreadSheet->getSheetCount(); ++$i) {
            ...
            } else if (isset($unparsedLoadedData['sheets'][$sheetCodeName]['drawingAlternateContents'])) {
                // Drawings
                $zipContent['xl/drawings/drawing' . ($i + 1) . '.xml'] = $this->getWriterPartDrawing()->writeDrawings($this->spreadSheet->getSheet($i), $this->includeCharts);
            }
        ...
        for ($i = 0; $i < $this->getDrawingHashTable()->count(); ++$i) {
            ...
            } else if ($this->getDrawingHashTable()->getByIndex($i) instanceof MemoryDrawing) {
                ob_start();
                /** @var callable */
     ...
     *
     * @param Spreadsheet $spreadsheet PhenyxXls object
     *
     * @return $this
     */
     ...
     * Get Style HashTable.
     *
     * @return HashTable<\phenyxDigitale\digitalSpreadSheet\Style\Style>
     */
    ...
    /**
     * Get \phenyxDigitale\digitalSpreadSheet\Style\Font HashTable.
     *
    ...
    /**
     * Get \phenyxDigitale\digitalSpreadSheet\Worksheet\Worksheet\BaseDrawing HashTable.
     *
