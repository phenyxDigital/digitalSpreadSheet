...
use phenyxDigitale\digitalSpreadSheet\Worksheet\Row;
use phenyxDigitale\digitalSpreadSheet\Worksheet\RowCellIterator;
use phenyxDigitale\digitalSpreadSheet\Worksheet\Worksheet;
use phenyxDigitale\digitalSpreadSheet\Writer\Exception;
use phenyxDigitale\digitalSpreadSheet\Writer\Ods;
use phenyxDigitale\digitalSpreadSheet\Writer\Ods\Cell\Comment;
use phenyxDigitale\digitalSpreadSheet\Writer\Ods\Cell\Style;
...
//                $objWriter->writeAttribute('table:number-columns-repeated', self::NUMBER_COLS_REPEATED_MAX);
    ...
    private function writeCells(XMLWriter $objWriter, RowCellIterator $cells): void{
        ...
        foreach ($cells as $cell) {
            /** @var \phenyxDigitale\digitalSpreadSheet\Cell\Cell $cell */
