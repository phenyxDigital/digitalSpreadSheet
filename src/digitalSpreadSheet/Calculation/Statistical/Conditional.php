...
use phenyxDigitale\digitalSpreadSheet\Calculation\Database\DAverage;
use phenyxDigitale\digitalSpreadSheet\Calculation\Database\DCount;
use phenyxDigitale\digitalSpreadSheet\Calculation\Database\DMax;
use phenyxDigitale\digitalSpreadSheet\Calculation\Database\DMin;
use phenyxDigitale\digitalSpreadSheet\Calculation\Database\DSum;
use phenyxDigitale\digitalSpreadSheet\Calculation\Exception as CalcException;
