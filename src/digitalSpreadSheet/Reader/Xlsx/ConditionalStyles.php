...
use phenyxDigitale\digitalSpreadSheet\Reader\Xlsx\Styles as StyleReader;
...
use phenyxDigitale\digitalSpreadSheet\Style\ConditionalFormatting\ConditionalFormatValueObject;
use phenyxDigitale\digitalSpreadSheet\Style\Style as Style;
...
class ConditionalStyles {
    ...
    private function readConditionalStyles(SimpleXMLElement $xmlSheet) : array
    {
        ...
        foreach ($xmlSheet->conditionalFormatting as $conditional) {
            ...
            foreach ($conditional->cfRule as $cfRule) {
                ...
                } else if ((string) $cfRule['type'] == Conditional::CONDITION_DATABAR) {
                    $conditionals[(string) $conditional['sqref']][(int) ($cfRule['priority'])] = $cfRule;
                }
    ...
    private function readStyleRules(array $cfRules, SimpleXMLElement $extLst): array
    {
        ...
        foreach ($cfRules as $cfRule) {
            ...
            } else if ((string) $cfRule['timePeriod'] != '') {
