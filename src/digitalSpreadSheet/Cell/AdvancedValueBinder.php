...
use phenyxDigitale\digitalSpreadSheet\Calculation\Engine\FormattedNumber;
    ...
    public function bindValue(Cell $cell, $value = null) {
        ...
        if ($dataType === DataType::TYPE_STRING && !$value instanceof RichText) {
            ...
            if (StringHelper::strToUpper($value) === Calculation::getTRUE()) {
                ...
                return true;
            } else if (StringHelper::strToUpper($value) === Calculation::getFALSE()) {
            ...
            } else if (preg_match('/^([+-]?)(\d*) +(\d*)\s?\/\s*(\d*)$/', $value, $matches)) {
